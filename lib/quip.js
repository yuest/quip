...
var exports = module.exports = function(charset){
    charset = charset || 'utf-8';
    return function(req, res, next){
        exports.update(res, charset);
        next();
    };
};

exports.update = function(res, charset){

    ///// default response settings /////
    res._quip_headers = {'Content-Type': 'text/html; charset=' + charset};
    ...
    // mime types
    res.text = withType('text/plain; charset=' + charset);
    res.plain = res.text;
    res.html = withType('text/html; charset=' + charset);
    res.xhtml = withType('application/xhtml+xml; charset=' + charset);
    res.css = withType('text/css; charset=' + charset);
    res.xml = withType('text/xml; charset=' + charset);
    res.atom = withType('application/atom+xml; charset=' + charset);
    res.rss = withType('application/rss+xml; charset=' + charset);
    res.javascript = withType('text/javascript; charset=' + charset);
    res.json = withType('application/json; charset=' + charset);
